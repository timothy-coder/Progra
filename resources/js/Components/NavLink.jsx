...
export default function NavLink({ href, active, children }) {
    return (
        <Link
            ...
            className={
                active
                ? 'inline-flex items-center ml-1 px-4 py-1.5 border-b-2 bg-lime-600 rounded-[7px] border-lime-600 text-sm font-bold leading-5 text-black focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
